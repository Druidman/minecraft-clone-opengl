...
float blockVertices[BLOCK_VERTICES_COUNT] = {
    ...
    -0.5f, -0.5f, -0.5f,  0.5f, 1.0f,  // 4
     ...
     0.5f, -0.5f,  0.5f,  0.75f, 0.75f,  // 6
    -0.5f, -0.5f,  0.5f,  0.5f, 0.75f,  // 7

    // Front face (Z+)
    -0.5f, -0.5f,  0.5f,  0.25f, 0.75f,  // 8
     0.5f, -0.5f,  0.5f,  0.5f, 0.75f,   // 9
     0.5f,  0.5f,  0.5f,  0.5f, 1.0f,   // 10
    -0.5f,  0.5f,  0.5f,  0.25f, 1.0f,  // 11

    // Back face (Z-)
    -0.5f, -0.5f, -0.5f,  0.5f, 0.75f,  // 12
     0.5f, -0.5f, -0.5f,  0.25f, 0.75f,   // 13
     0.5f,  0.5f, -0.5f,  0.25f, 1.0f,   // 14
    -0.5f,  0.5f, -0.5f,  0.5f, 1.0f,  // 15

    // Left face (X-)
    -0.5f, -0.5f, -0.5f,  0.25f, 0.75f,  // 16
    -0.5f, -0.5f,  0.5f,  0.5f, 0.75f,   // 17
    -0.5f,  0.5f,  0.5f,  0.5f, 1.0f,   // 18
    -0.5f,  0.5f, -0.5f,  0.25f, 1.0f,  // 19

    // Right face (X+)
     0.5f, -0.5f, -0.5f,  0.5f, 0.75f,  // 20
     0.5f, -0.5f,  0.5f,  0.25f, 0.75f,   // 21
