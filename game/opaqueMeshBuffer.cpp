...
bool OpaqueMeshBuffer::markData(BufferInt markStart, BufferInt markEnd)
{
...
std::string OpaqueMeshBuffer::getBufferTypeString()
{
...
bool OpaqueMeshBuffer::insertChunksToBuffer(std::vector<Chunk *> *chunks)
{
    return false;
}
