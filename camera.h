...
class Camera {
    ...
    public:
        ...
        glm::vec3 position;
        glm::vec3 positionChangeSinceLastWorldShift = glm::vec3(0.0f);
        ...
        glm::mat4 getViewMatrix(){
            ...
            return glm::lookAt(positionChangeSinceLastWorldShift,positionChangeSinceLastWorldShift + this->direction, this->up);
        };
